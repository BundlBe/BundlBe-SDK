Pod::Spec.new do |s|
  ...
  s.homepage         = 'https://github.com/BundlBe/BundlBe-SDK'
  s.source           = { :git => 'https://github.com/BundlBe/BundlBe-SDK.git', :tag => s.version.to_s }

  s.authors          = { 'BundlBe' => 'support@bundlbe.com' }
